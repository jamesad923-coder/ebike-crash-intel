# Data brief: E-scooter injury reported in South Burlington, VT (2026-08-12)
...
>    South Burlington, VT — automated location extraction does sometimes attach
...
- Sources:
  - [wcax.com](https://www.wcax.com/2026/08/12/e-scooter-rider-seriously-injured-crash-with-bus-burlington/)

## South Burlington in the federal fatality data

- **South Burlington, VT**: 3 recorded cyclist fatalities in FARS 2019–2024, of which 0 were minors (under 18).
- Year by year: 2019: 0, 2020: 0, 2021: 0, 2022: 1, 2023: 0, 2024: 2.
- **Small numbers**: at this count, a single crash changes the picture entirely; no trend can be inferred from city data alone.
- Most common crash type coded in this city's reports (PBCAT): “Motorist Overtaking Bicyclist” (2 of 3). This is what crash reports found, not a fault judgment.
- City data page: https://jamesad923-coder.github.io/ebike-crash-intel/cities/vt/south-burlington/

## State context

- **Vermont**: 5 pedalcyclist fatalities in FARS 2019–2024 (#50 among states by raw count — a count, not a rate; larger states rank high partly because more people ride).
- Adjusted for bike-commute share (an imperfect but real exposure proxy), Vermont ranks **#48** at 8.0 fatalities per 10k bike commuters (raw-count rank #50).
