# Data brief: E-scooter fatality reported in Las Cruces, NM (2026-08-06)
...
>    Las Cruces, NM — automated location extraction does sometimes attach
...
- Sources:
  - [cbs4local.com](https://cbs4local.com/news/nation-world/two-13-year-old-girls-electric-scooter-killed-crash-truck-utah)

## Las Cruces in the federal fatality data

- **Las Cruces, NM**: 6 recorded cyclist fatalities in FARS 2019–2024, of which 0 were minors (under 18).
- Year by year: 2019: 1, 2020: 0, 2021: 0, 2022: 1, 2023: 3, 2024: 1.
- Most common crash type coded in this city's reports (PBCAT): “Parallel Paths - Other Circumstances” (1 of 6). This is what crash reports found, not a fault judgment.
- City data page: https://jamesad923-coder.github.io/ebike-crash-intel/cities/nm/las-cruces/

## State context

- **New Mexico**: 46 pedalcyclist fatalities in FARS 2019–2024 (#32 among states by raw count — a count, not a rate; larger states rank high partly because more people ride).
- Adjusted for bike-commute share (an imperfect but real exposure proxy), New Mexico ranks **#21** at 35.23 fatalities per 10k bike commuters (raw-count rank #32).
