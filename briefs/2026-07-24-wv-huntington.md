# Data brief: E-bike fatality reported in Huntington, WV (2026-07-24)
...
>    Huntington, WV — automated location extraction does sometimes attach
...
- Sources:
  - [wsaz.com](https://www.wsaz.com/2026/07/24/wsaz-investigators-asking-public-come-forward-with-info-marly-kinneys-death-wva-house-speaker-calling-session-remove-delegate-other-top-stories/)

## Huntington in the federal fatality data

- Huntington has fewer than 3 recorded cyclist fatalities in FARS 2019–2024, so it does not have a standing city page. That is itself worth knowing: the local discussion is likely driven by injuries and near misses, which federal fatality data does not capture.

## State context

- **West Virginia**: 18 pedalcyclist fatalities in FARS 2019–2024 (#40 among states by raw count — a count, not a rate; larger states rank high partly because more people ride).
- Adjusted for bike-commute share (an imperfect but real exposure proxy), West Virginia ranks **#14** at 65.43 fatalities per 10k bike commuters (raw-count rank #40).
