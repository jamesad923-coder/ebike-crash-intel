# Data brief: E-bike injury reported in Sacramento, CA (2026-06-27)
...
>    Sacramento, CA — automated location extraction does sometimes attach
...
- Sources:
  - [wisn.com](https://www.wisn.com/article/e-bike-rider-hurt-after-collision-with-pick-up-truck-in-west-allis/71750340)

## Sacramento in the federal fatality data

- **Sacramento, CA**: 27 recorded cyclist fatalities in FARS 2019–2024, of which 0 were minors (under 18).
- Year by year: 2019: 2, 2020: 2, 2021: 1, 2022: 7, 2023: 9, 2024: 6.
- Most common crash type coded in this city's reports (PBCAT): “Bicyclist Left Turn / Merge” (5 of 27). This is what crash reports found, not a fault judgment.
- City data page: https://jamesad923-coder.github.io/ebike-crash-intel/cities/ca/sacramento/

## State context

- **California**: 937 pedalcyclist fatalities in FARS 2019–2024 (#2 among states by raw count — a count, not a rate; larger states rank high partly because more people ride).
- Adjusted for bike-commute share (an imperfect but real exposure proxy), California ranks **#26** at 25.44 fatalities per 10k bike commuters (raw-count rank #2).
