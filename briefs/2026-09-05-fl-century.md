# Data brief: E-bike injury reported in Century, FL (2026-09-05)
...
>    Century, FL — automated location extraction does sometimes attach
...
- Sources:
  - [northescambia.com](http://www.northescambia.com/2026/09/escambia-ems-ambulance-collides-with-e-bike-rider-while-responding-to-another-crash)

## Century in the federal fatality data

- Century has fewer than 3 recorded cyclist fatalities in FARS 2019–2024, so it does not have a standing city page. That is itself worth knowing: the local discussion is likely driven by injuries and near misses, which federal fatality data does not capture.

## State context

- **Florida**: 1216 pedalcyclist fatalities in FARS 2019–2024 (#1 among states by raw count — a count, not a rate; larger states rank high partly because more people ride).
- Adjusted for bike-commute share (an imperfect but real exposure proxy), Florida ranks **#5** at 93.13 fatalities per 10k bike commuters (raw-count rank #1).
