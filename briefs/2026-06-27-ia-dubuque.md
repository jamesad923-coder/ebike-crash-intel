# Data brief: E-bike injury reported in Dubuque, IA (2026-06-27)
...
>    Dubuque, IA — automated location extraction does sometimes attach
...
- Sources:
  - [telegraphherald.com](https://www.telegraphherald.com/news/tri-state/article_3b4ba382-ad80-4897-96bf-1a9ea0f41d86.html)

## Dubuque in the federal fatality data

- Dubuque has fewer than 3 recorded cyclist fatalities in FARS 2019–2024, so it does not have a standing city page. That is itself worth knowing: the local discussion is likely driven by injuries and near misses, which federal fatality data does not capture.

## State context

- **Iowa**: 43 pedalcyclist fatalities in FARS 2019–2024 (#33 among states by raw count — a count, not a rate; larger states rank high partly because more people ride).
- Adjusted for bike-commute share (an imperfect but real exposure proxy), Iowa ranks **#35** at 16.43 fatalities per 10k bike commuters (raw-count rank #38).
