# Data brief: E-scooter fatality reported in Granby, NY (2026-07-06)
...
>    Granby, NY — automated location extraction does sometimes attach
...
## Granby in the federal fatality data

- Granby has fewer than 3 recorded cyclist fatalities in FARS 2019–2024, so it does not have a standing city page. That is itself worth knowing: the local discussion is likely driven by injuries and near misses, which federal fatality data does not capture.
