# Data brief: E-bike fatality reported in Hanover County, NC (2026-09-20)
...
>    Hanover County, NC — automated location extraction does sometimes attach
...
- Sources:
  - [wwaytv3.com](https://www.wwaytv3.com/bike-safety-summit-held-as-wilmington-area-works-to-make-roads-safer/)

## Hanover County in the federal fatality data

- Hanover County has fewer than 3 recorded cyclist fatalities in FARS 2019–2024, so it does not have a standing city page. That is itself worth knowing: the local discussion is likely driven by injuries and near misses, which federal fatality data does not capture.

## State context

- **North Carolina**: 179 pedalcyclist fatalities in FARS 2019–2024 (#9 among states by raw count — a count, not a rate; larger states rank high partly because more people ride).
- Adjusted for bike-commute share (an imperfect but real exposure proxy), North Carolina ranks **#6** at 89.92 fatalities per 10k bike commuters (raw-count rank #8).
