# Data brief: E-scooter fatality reported in Skaneateles, NY (2026-07-05)
...
>    Skaneateles, NY — automated location extraction does sometimes attach
...
- Sources:
  - [oswegocountytoday.com](https://oswegocountytoday.com/lead-story/state-police-investigate-fatal-electric-scooter-crash-in-granby/)

## Skaneateles in the federal fatality data

- Skaneateles has fewer than 3 recorded cyclist fatalities in FARS 2019–2024, so it does not have a standing city page. That is itself worth knowing: the local discussion is likely driven by injuries and near misses, which federal fatality data does not capture.
