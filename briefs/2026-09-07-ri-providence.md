# Data brief: E-scooter injury reported in Providence, RI (2026-09-07)
...
>    Providence, RI — automated location extraction does sometimes attach
...
- Sources:
  - [turnto10.com](https://turnto10.com/news/local/providence-police-ask-for-help-identifying-youth-injured-in-e-scooter-accident-broad-street-atlantic-avenue-hasbro-childrens-hospital-sept-6-2026)

## Providence in the federal fatality data

- **Providence, RI**: 3 recorded cyclist fatalities in FARS 2019–2024, of which 0 were minors (under 18).
- Year by year: 2019: 0, 2020: 0, 2021: 1, 2022: 0, 2023: 1, 2024: 1.
- **Small numbers**: at this count, a single crash changes the picture entirely; no trend can be inferred from city data alone.
- Most common crash type coded in this city's reports (PBCAT): “Bicyclist Failed to Yield - Signalized Intersection” (1 of 3). This is what crash reports found, not a fault judgment.
- City data page: https://jamesad923-coder.github.io/ebike-crash-intel/cities/ri/providence/

## State context

- **Rhode Island**: 11 pedalcyclist fatalities in FARS 2019–2024 (#45 among states by raw count — a count, not a rate; larger states rank high partly because more people ride).
- Adjusted for bike-commute share (an imperfect but real exposure proxy), Rhode Island ranks **#42** at 10.43 fatalities per 10k bike commuters (raw-count rank #47).
